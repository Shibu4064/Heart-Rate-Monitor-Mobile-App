...
val ElegantSecondaryContainer = Color(0xFF2B2930)
val ElegantOnSecondaryContainer = Color(0xFFCAC4D0)
...
val ElegantOutlineVariant = Color(0xFF49454F)
val ElegantErrorContainer = Color(0xFF8C1D18)
val ElegantOnErrorContainer = Color(0xFFF9DEDC)
